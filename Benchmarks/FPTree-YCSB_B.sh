...
cd BenchmarkingTrees/Benchmarks/YCSB_B/FPTree

for totalTreads in 1 2 4 8 16 32
do

echo "Running YCSB_B on FPTree with $totalTreads concurrent threads..."
sudo parallel -j $totalTreads :::: FPTree-$totalTreads-threads-YCSB_B.benchmark > FPTree-$totalTreads-threads-YCSB_B.result
