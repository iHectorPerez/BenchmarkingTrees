...
cd BenchmarkingTrees/Benchmarks/YCSB_E/FPTree

for totalTreads in 1 2 4 8 16 32
do

echo "Running YCSB_E on FPTree with $totalTreads concurrent threads..."
sudo parallel -j $totalTreads :::: FPTree-$totalTreads-threads-YCSB_E.benchmark > FPTree-$totalTreads-threads-YCSB_E.result
