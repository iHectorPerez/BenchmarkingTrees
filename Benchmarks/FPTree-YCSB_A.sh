...
cd BenchmarkingTrees/Benchmarks/YCSB_A/FPTree

for totalTreads in 1 2 4 8 16 32
do

echo "Running YCSB_A on FPTree with $totalTreads concurrent threads..."
sudo parallel -j $totalTreads :::: FPTree-$totalTreads-threads-YCSB_A.benchmark > FPTree-$totalTreads-threads-YCSB_A.result
