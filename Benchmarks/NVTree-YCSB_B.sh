...
cd BenchmarkingTrees/Benchmarks/YCSB_B/NVTree

for totalTreads in 1 2 4 8 16 32
do

echo "Running YCSB_B on NV-Tree with $totalTreads concurrent threads..."
sudo parallel -j $totalTreads :::: NVTree-$totalTreads-threads-YCSB_B.benchmark > NVTree-$totalTreads-threads-YCSB_B.result
