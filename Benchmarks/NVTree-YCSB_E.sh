...
cd BenchmarkingTrees/Benchmarks/YCSB_E/NVTree

for totalTreads in 1 2 4 8 16 32
do

echo "Running YCSB_E on NV-Tree with $totalTreads concurrent threads..."
sudo parallel -j $totalTreads :::: NVTree-$totalTreads-threads-YCSB_E.benchmark > NVTree-$totalTreads-threads-YCSB_E.result
