...
cd BenchmarkingTrees/Benchmarks/YCSB_A/RNTree

for totalTreads in 1 2 4 8 16 32
do

echo "Running YCSB_A on RNTree with $totalTreads concurrent threads..."
sudo parallel -j $totalTreads :::: RNTree-$totalTreads-threads-YCSB_A.benchmark > RNTree-$totalTreads-threads-YCSB_A.result
