...
cd BenchmarkingTrees/Benchmarks/YCSB_E/RNTree

for totalTreads in 1 2 4 8 16 32
do

echo "Running YCSB_E on RNTree with $totalTreads concurrent threads..."
sudo parallel -j $totalTreads :::: RNTree-$totalTreads-threads-YCSB_E.benchmark > RNTree-$totalTreads-threads-YCSB_E.result
